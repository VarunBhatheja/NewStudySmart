...
import com.example.newstudysmart.presentation.components.SubjectListBottomSheet
import com.example.newstudysmart.ui.theme.Red
import com.example.newstudysmart.util.SnackbarEvent
import com.example.studysmart.presentation.session.SessionEvent
...
@Destination(
    deepLinks = [
        DeepLink(
            ...
            uriPattern = "new_study_smart://dashboard/session"
        )
    ]
)
@Composable
        ...
        LazyColumn(
            ...
            item {
                RelatedToSubjectSection(
                    ...
                    relatedToSubject = state.relatedToSubject ?: "Select the subject",
